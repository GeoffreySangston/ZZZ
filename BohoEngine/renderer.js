...
Renderer.prototype.fillRect = function(x,y,w,h,theta,pw,ph,color){
	...
	this.context.fillRect(x + this.cameraX,y + this.cameraY,w,h);
	this.context.stroke();
	this.context.restore();
	
};

Renderer.prototype.drawImage = function(img,clipX,clipY,clipWidth,clipHeight,x,y,w,h,theta,pw,ph){
	...
	this.context.drawImage(img,clipX,clipY,clipWidth,clipHeight,x + this.cameraX,y + this.cameraY,w,h);
	this.context.restore();
